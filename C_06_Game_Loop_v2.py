...
# At start of the game, the computer / user score are both zero
comp_score = 0
user_score = 0
rounds_played = 0

game_goal = int(input("Game Goal:"))    # should be a functions call!
...
while comp_score < game_goal and user_score < game_goal:
    ...
    print(f"User Score: {user_score} | Computer score {comp_points}")


# end of entire game, output final results

make_statement("Game Over","🕸️")
